...
/**
 * @file
 * Contains \Drupal\rsvplist_tool\Controller\ReportController.
 */
namespace Drupal\rsvplist_tool\Controller;
...
class ReportController extends ControllerBase {
  ...
  protected function load() {
    $select = Database::getConnection()->select('rsvplist_tool', 'r');
