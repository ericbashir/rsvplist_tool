...
/**
 * @file
 * Contains \Drupal\rsvplist_tool\EnablerService.
 */

namespace Drupal\rsvplist_tool;
...
class EnablerService {
  ...
  public function setEnabled(Node $node) {
    if (!$this->isEnabled($node)) {
      $insert = Database::getConnection()->insert('rsvplist_tool_enabled');
  ...
  public function isEnabled(Node $node) {
    ...
    $select = Database::getConnection()->select('rsvplist_tool_enabled', 're');
  ...
  public function delEnabled(Node $node) {
    $delete = Database::getConnection()->delete('rsvplist_tool_enabled');
